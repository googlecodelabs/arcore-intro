...
/// <summary>
/// Renders the TrackedPlane using a mesh.  Also add a mesh collider.
/// </summary>
public class TrackedPlaneController : MonoBehaviour
{
  ...
  /// </summary>
  public TrackedPlane trackedPlane;
  ...
  private void _UpdateMeshWithCurrentTrackedPlane ()
  {
    ...
    //    transform.localRotation = trackedPlane.Rotation;
    //   GetComponent<Rigidbody>().MovePosition(trackedPlane.Position);
